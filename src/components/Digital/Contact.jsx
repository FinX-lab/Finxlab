...
const Contact = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    const res = await axios
      .post("http://localhost/finxlab/contact.php", formValues)
      ...
      <div className="container">
        <div className="section-head mb-60 text-center">
          ...
          <h2 className="wow fadeInUp text-white">
            Business and IT <span className="fw-normal">Firm</span>
          </h2>
        </div>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-5">
              <div className="contact_info text-white">
                <p className="wow fadeInUp">Sun to Fri</p>
                ...
                <a href="/page-contact-5" className="wow fadeInUp">
                  get direction
                </a>
              </div>
            </div>
            <div className="col-lg-6 offset-lg-1">
              <form
                ...
                action="http://localhost/finxlab/contact.php"
                method="post"
