          ...
          <div className="col-lg-4">
            <div className="info">
              ...
              <div className="text mb-50 fs-12px color-666">
                {rtl
                  ? "في Iteck، نقدم لك مجموعة من الحلول التكنولوجية التي تساهم في نمو عملك وتطويره."
                  : "At FinxLab, we provide a range of technology solutions designed to drive your business growth and development."}
              </div>
              <ul>
                {ChooseUsData.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="inf">
                      <h5>{item.info}</h5>
                      <p className="fs-12px color-666 mt-2">{item.details}</p>
                    </div>
                  </li>
                ))}
              </ul>
              <Link
                to={rtl ? "/rtl-page-services" : "/page-services-5"}
